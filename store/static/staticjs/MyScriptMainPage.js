...
//---------------------------------------------------------------
// SignUp Btn After And Before Login
let signUpBtn = document.getElementById("SignBtnStyle");
if (signUpBtn.innerText == "AnonymousUser") {
  signUpBtn.innerText = "ورود / ثبت نام";
  signUpBtn.setAttribute("onclick", "location.href='/customer/login/'");
}
//--------------------------------------------------------------
//Sticky Menu
